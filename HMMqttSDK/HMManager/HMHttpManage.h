 ...
 * @param name        设备名称
 */
+ (void)onRegisterDeviceWithPid:(NSInteger)pid mac:(NSString *)mac mcuVersion:(NSString *)mcuVersion wifiVersion:(NSString *)wifiVersion name:(NSString *)name success:(void (^)(id data))success failure:(void (^)(NSError * error))failure;
...
/**
 ...
 @param deviceId      父设备产品id
 @param subDeviceInfo 子设备信息  （"id": "子设备id"+ "pId": "子设备产品id"）
 @param success       成功回调
 @param failure       失败回调
 */
+ (void)onOtaGetMsgWithDeviceId:(NSArray *)deviceId subDeviceInfo:(NSArray *)subDeviceInfo success:(void (^)(id data))success failure:(void (^)(NSError * error))failure;
...
+ (void)onChangeSceneWithSceneId:(NSString *)sceneId SceneName:(NSString *)sceneName sceneIcon:(NSString *)sceneIcon countTime:(NSString *)countTime execList:(NSArray *)execList success:(void (^)(id data))success failure:(void (^)(NSError * error))failure;
 ...
 * @param failure      失败回调
 */
+ (void)onLinkCreateWithLinkName:(NSString *)linkName checkEn:(BOOL)checkEn countTime:(NSString *)countTime conList:(NSDictionary *)conList checkList:(NSArray *)checkList execList:(NSArray  *)execList success:(void (^)(id data))success failure:(void (^)(NSError * error))failure;
 ...
 * 推送信鸽token注册
 *
 * @param appId        信鸽应用在管理后台的id
 * @param deviceToken  信鸽推送凭证
 * @param success      成功回调
 * @param failure      失败回调
 */
+ (void)onRegisterXGWithAppId:(NSInteger )appId deviceToken:(NSString *)deviceToken success:(void (^)(id data))success failure:(void (^)(NSError * error))failure;
 ...
 * @param failure      失败回调
 */
+ (void)onUnRegisterXGWithAppId:(NSInteger )appId success:(void (^)(id data))success failure:(void (^)(NSError * error))failure;
